...
class Expert(Agent):
    ...
    def execute(self, agent_message: AgentMessage, retry_count: int = 0) -> AgentMessage:
        ...
        message_service.save_workflow_message(workflow_message=workflow_message, job_id=job.id)
        ...
        if workflow_message.status == WorkflowStatus.SUCCESS:
            ...
            return message_service.save_agent_message(agent_message=agent_message)
